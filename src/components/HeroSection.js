...
const HeroSection = ({ gradientType = 1 }) => {
  ...
  const gradients = [
    'bg-gradient-to-br from-indigo-900 to-purple-800', // Original
    'bg-gradient-to-br from-purple-900 via-pink-600 to-blue-500', // Morado neón
    'bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800'  // Oscuro moderno
  ];
  ...
  return (
    <section className={`min-h-screen flex flex-col justify-center items-center ${gradients[gradientType]} text-white px-4 relative overflow-hidden`}>
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-white opacity-5 rounded-full"></div>
